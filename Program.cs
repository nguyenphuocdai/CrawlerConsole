...
namespace Crawler
{
	class Program
	{
		static void Main()
		{
			...
			const string website = "https://odindesignthemes.com/vikinger/members.html";
			...
			var crawlerProcesser = new ImageCrawlerProcesser(crawlerProcessorRules, @"D:\Images\Crawler");
